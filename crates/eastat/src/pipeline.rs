//! Pipeline implementation: scan → layout → parse → stats.

use libloading::{Library, Symbol};
use std::path::Path;

use crate::{
    ColumnStats, ProcessError, ProcessResult,
    load_lib,
    BatchAtofFn, BuildRowArraysFn, BuildRowDelimIndexFn, ComputeFieldBoundsFn,
    F32ColumnStatsFn, F32PercentilesFn, FieldLengthStatsFn, ScanFastFn, ScanQuotedFn,
};
